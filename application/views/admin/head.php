<!-- include this page before <body> tag -->

<head>    
    <title><?php echo isset($page_title) ? $page_title : 'GoPray'?></title>
    ...
    <link rel="stylesheet"  type="text/css" href="<?php echo URL_CSS?>style2_admin.css">
    <link rel="stylesheet" type="text/css" href="<?php echo URL_CSS?>jquery.dataTables.min.css">
